...
void VAO::addAttribute(GLsizei size, void* data, GLuint unitsPerVertex,
                       GLenum type, GLuint id, GLenum usage) {
...
void VAO::addAttribute(GLuint bufferId, GLuint unitsPerVertex, GLenum type,
                       GLuint id) {
  glBindVertexArray(GLVaoId);
...
void VAO::updateAttribute(GLintptr offset, GLsizei size, void* data,
                          GLuint id) {
