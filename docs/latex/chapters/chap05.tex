...
\begin{table}[htbp]
	...
	\end{tabular}
	\caption{Resultados obtenidos en el segundo caso de prueba. Notación: GL, E, Híb corresponden a OpenGL, Embree e Híbrido; D+S indica que se utilizaron reflexiones difusas y especulares.}
	\label{tab:caso2}
\end{table}
