...
La gestión de las tareas a relizar se llevó a cabo en el respositiorio del proyecto, con tareas como las vistas en la Figura \ref{img:kanban}. Donde se consideran un conjunto de tareas:
